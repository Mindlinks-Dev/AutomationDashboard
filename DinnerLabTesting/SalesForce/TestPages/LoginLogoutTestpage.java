...
public class LoginLogoutTestpage {
	...
	int loginRowCount = xllib.getRowCount("SalesForceLighting");
	System.out.println("loginRowCount:"+loginRowCount);
	for(i=1;i<= loginRowCount;i++)
	{
	URL = xllib.getExcelData("SalesForceLighting", i, 0);
	Username = xllib.getExcelData("SalesForceLighting", i, 1);
	Password = xllib.getExcelData("SalesForceLighting", i, 2);
