...
public class Testbase {
	...
	public static void setup() throws IOException, InterruptedException  {
		...
		if (driver == null) {
				...
				fis = new FileInputStream("D:\\DinnerLabWorkspace\\DinnerLabTesting\\src\\genericcode\\Config");
	...
	/*		
			...
			fis = new FileInputStream("D:\\DinnerLabWorkspace\\DinnerLabTesting\\src\\genericcode\\OR");
...
Thread.sleep(8000);
	        ...
	        un.sendKeys(Keys.TAB,config.getProperty("pwd"),Keys.TAB.ENTER);
