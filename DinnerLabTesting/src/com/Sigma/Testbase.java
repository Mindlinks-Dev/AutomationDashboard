...
public class Testbase {
	...
	public static void setup() throws IOException, InterruptedException  {
		...
		if (driver == null) {
				...
				fis = new FileInputStream("D:\\AutomationDashboard\\DinnerLabTesting\\src\\com\\Sigma\\Config");
           ...
           log.debug("loading config file");
				...
				fis = new FileInputStream("D:\\AutomationDashboard\\DinnerLabTesting\\src\\com\\Sigma\\OR");
