...
import com.dinnerLab.userPages.Helpers.AddNewCreditCardInfoPage;
import com.dinnerLab.util.DriverManager;
import com.pack.ScriptHandler;

public class AddNewCreditCardInfoTest 
{
	 ...
	 */	 
	@Test
	 public void addNewCreditCardInfoTest() throws Exception
	 {
		...
		AddNewCreditCardInfoPage newCard = new AddNewCreditCardInfoPage();
		newCard.addNewCreditCardInfoInitialPage(driver);
