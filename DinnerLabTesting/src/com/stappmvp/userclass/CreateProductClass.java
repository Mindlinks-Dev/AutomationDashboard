...
import com.stappmvp.userpage.CreateProductPage;
import com.stappmvp.userpage.Userloginlogoutpage;

public class CreateProductClass
{
	private static Logger log = Logger.getLogger(CreateProductClass.class);
	public WebDriver driver;
	 ...
	 public void CreateProductTest() throws Exception
	 {
		...
		CreateProductPage A1 = new CreateProductPage();
		A1.ProductInitialPage(driver);
		driver.manage().timeouts().implicitlyWait(80, TimeUnit.SECONDS);
