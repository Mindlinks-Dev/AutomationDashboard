...
public class Testbase1 {
	...
	public static void setup() throws IOException, InterruptedException  {
		...
		if (driver == null) {
				...
				fis = new FileInputStream("D:\\AutomationDashboard\\DinnerLabTesting\\src\\com\\dynamicload\\Config1");
           ...
           log.debug("loading config file");
				...
				fis = new FileInputStream("D:\\AutomationDashboard\\DinnerLabTesting\\src\\com\\dynamicload\\OR1");
