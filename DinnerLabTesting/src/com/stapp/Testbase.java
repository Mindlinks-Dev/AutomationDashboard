...
public class Testbase 
{
	...
	//public static ExcelReading excel = new ExcelReading("D:\\Selenium\\scripts\\src\\ExcellData\\NewStappSanityCheckData.xlsx");
	//public static ExcelReading excel = new ExcelReading("D:\\AutomationDashboard\\DinnerLabTesting\\src\\TestData\\Stapp2.0TestData.xlsx");		
	public static ExcelReading excel = new ExcelReading("D:\\AutomationDashboard\\DinnerLabTesting\\src\\TestData\\Locationdata.xlsx");		
	...
	public static void setup() throws IOException, InterruptedException 
	{
		...
		if (driver == null) 
		{
		   ...
		   fis = new FileInputStream("D:\\AutomationDashboard\\DinnerLabTesting\\src\\com\\stapp\\Config");
		   ...
		   fis = new FileInputStream("D:\\AutomationDashboard\\DinnerLabTesting\\src\\com\\stapp\\OR");
		   ...
		   log.debug("loading or file");
			...
			if(config.getProperty("Browser").equals("chrome")) 
			{
				...
				System.setProperty("webdriver.chrome.driver","D:\\AutomationDashboard\\DinnerLabTesting\\src\\chromedriver_win32(2.36)\\chromedriver.exe");
