...
import com.SigmaERP.testpage.CreatePackagePage;
import com.SigmaERP.testpage.Userloginlogoutpage;
import com.dinnerLab.util.DriverManager;

public class CreatePackageClass
{
	private static Logger log = Logger.getLogger(CreatePackageClass.class);
	public WebDriver driver;
	 ...
	 public void CreatePackageTest() throws Exception
	 {
		...
		CreatePackagePage  E1 = new CreatePackagePage();
		E1.PackageInitialPage(driver);
	 }
}
